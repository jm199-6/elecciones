...
<div class="col-lg-3 col-md-3 col-sm-3">
    <img class="img img-responsive" src="./img/ERROR_404_grande.jpg" >
</div>
...
<div class="col-lg-9 col-md-9 col-sm-9">
    ...
    <p>
        <font face="ComicSansMs" size="5">
            ...
            <!-- PARA SABER LA CARPETA ACTUAL dirname(__FILE__); -->
            <?php 
                echo dirname(__FILE__);
            ?>
            La URL de la <a href="http://localhost/elecciones/<?php echo basename(dirname(__FILE__)); ?>index.php?pag=<?php echo $_GET['ps']; ?>">p&aacute;gina <?php echo substr($_GET['ps'], 0, strlen($_GET['ps'])-4); ?> que le ha remitido</a> 
            parece ser err&oacute;nea, estar obsoleta o no existe el recurso solicitado. Por favor, informe del error 
            al autor de <a href="http://juegos.jose.com/juegos/indexa.php%3fpag=consola.php">esa
            p&aacute;gina</a>.
        </font>
    ...
    <address>
      <a href="/elecciones/indexa.php">localhost</a>
    </address>
</div>
